...
const static std::unordered_map<std::pair<BlockType, Direction>, std::pair<int, glm::vec2>, PairEnumHash> btToUV {
    ...
    {std::make_pair(TATAMI_X, XPOS), std::make_pair(0, glm::vec2(11, 9))},
    {std::make_pair(TATAMI_X, XNEG), std::make_pair(0, glm::vec2(11, 9))},
    {std::make_pair(TATAMI_X, ZPOS), std::make_pair(0, glm::vec2(11, 10))},
    {std::make_pair(TATAMI_X, ZNEG), std::make_pair(0, glm::vec2(11, 10))},
    {std::make_pair(TATAMI_X, YPOS), std::make_pair(0, glm::vec2(11, 11))},
    {std::make_pair(TATAMI_X, YNEG), std::make_pair(0, glm::vec2(11, 11))},

    {std::make_pair(TATAMI_Z, XPOS), std::make_pair(0, glm::vec2(11, 10))},
    {std::make_pair(TATAMI_Z, XNEG), std::make_pair(0, glm::vec2(11, 10))},
    {std::make_pair(TATAMI_Z, ZPOS), std::make_pair(0, glm::vec2(11, 9))},
    {std::make_pair(TATAMI_Z, ZNEG), std::make_pair(0, glm::vec2(11, 9))},
