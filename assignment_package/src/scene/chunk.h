...
const static std::unordered_map<std::pair<BlockType, Direction>, std::pair<int, glm::vec2>, PairEnumHash> btToUV {
    ...
    {std::make_pair(COTTON_1, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_1, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_1, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_1, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_1, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_1, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_2, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_2, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_2, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_2, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_2, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_2, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_3, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_3, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_3, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_3, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_3, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_3, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_4, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_4, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_4, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_4, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_4, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_4, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_5, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_5, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_5, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_5, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_5, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_5, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_6, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_6, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_6, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_6, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_6, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_6, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_7, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_7, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_7, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_7, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_7, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_7, YNEG), std::make_pair(0, glm::vec2(12, 9))},

    {std::make_pair(COTTON_8, XPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_8, XNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_8, ZPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_8, ZNEG), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_8, YPOS), std::make_pair(0, glm::vec2(12, 9))},
    {std::make_pair(COTTON_8, YNEG), std::make_pair(0, glm::vec2(12, 9))},
