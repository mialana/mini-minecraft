...
static std::unordered_map<BlockType, QString>
    typeStringPairs{{GRASS, "Grass"},
                    {DIRT, "Dirt"},
                    {STONE, "Stone"},
...
static std::unordered_map<std::pair<BlockType, BlockType>, BlockType, TypePairHash>
    craftingRecipes{{std::make_pair(GRASS, DIRT), SAND},
                    {std::make_pair(ICE, SNOW_1), WATER},
                    {std::make_pair(SNOW_1, ICE), WATER},
                    {std::make_pair(STONE, COBBLESTONE), MOSS_STONE},
                    {std::make_pair(DIRT, STRAW), TILLED_DIRT},
                    {std::make_pair(TILLED_DIRT, WHEAT_1), STRAW},
                    {std::make_pair(WHEAT_8, RICE_1), WATER},
                    {std::make_pair(RICE_6, RICE_6), RICE_5},
                    {std::make_pair(TEAK_PLANKS, CEDAR_PLANKS), CHERRY_PLANKS},
                    {std::make_pair(CEDAR_PLANKS, TEAK_PLANKS), CHERRY_PLANKS},
                    {std::make_pair(CHERRY_PLANKS, MAPLE_PLANKS), PINE_PLANKS},
                    {std::make_pair(MAPLE_PLANKS, CHERRY_PLANKS), PINE_PLANKS},
                    {std::make_pair(CHERRY_PLANKS, WISTERIA_PLANKS), MAPLE_PLANKS},
                    {std::make_pair(WISTERIA_PLANKS, PINE_PLANKS), MAPLE_PLANKS},
                    {std::make_pair(WISTERIA_BLOSSOMS_1, WISTERIA_BLOSSOMS_2), WISTERIA_BLOSSOMS_3},
                    {std::make_pair(WISTERIA_BLOSSOMS_2, WISTERIA_BLOSSOMS_1), WISTERIA_BLOSSOMS_3},
                    {std::make_pair(BAMBOO_1, BAMBOO_2), BAMBOO_3},
                    {std::make_pair(BAMBOO_2, BAMBOO_3), BAMBOO_1},
                    {std::make_pair(BAMBOO_3, BAMBOO_1), BAMBOO_2},
                    {std::make_pair(LILY_PAD, LOTUS_1), WATER},
                    {std::make_pair(LOTUS_1, LOTUS_2), WATER},
                    {std::make_pair(LOTUS_2, LILY_PAD), WATER}};
