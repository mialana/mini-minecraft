...
uniform vec4
    u_Color;  // When drawing the cube instance, we'll set our uniform color to represent different block types.
...
out vec2 fs_UV;
out vec4 fs_BiomeWts;
flat out int fs_TexIdx;
out vec4
